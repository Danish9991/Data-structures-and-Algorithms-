...
export class BinarySearchTree {
  ...
  /**
   * remove method is used to remove the node from binary tree
   * Time Complexity O(log(n))
   * Space Complexity O(n)
   * @returns
   */
  ...
  /**
   * breadthFirstSearch methods returns the list of nodes
   * Time Complexity 0(n)
   * @returns
   */
  ...
  /**
   * breadthFirstSearchR method returns the list of nodes
   * @param {*} queue
   * @param {*} list
   * @returns
   */
